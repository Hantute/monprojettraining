...
@NgModule({
  ...
  providers: [FakeSessionItemService] // On peux appeller un service dans plusieur composant en les déclarants au niveau module,
  // il peux être utiliser dans tout les composants
